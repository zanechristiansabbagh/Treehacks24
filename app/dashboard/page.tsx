    ...
    <div className="flex flex-col gap-4 w-full">
      <Card>
        <CardHeader className="pb-0 text-center">
          <CardTitle className="text-3xl">Question answering over time</CardTitle>
          <CardDescription className="text-xl">Percentage of questions answered correctly over time</CardDescription>
        </CardHeader>
        <CardContent>
