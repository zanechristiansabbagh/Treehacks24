    ...
    <div className="max-w-2xl mx-auto my-8">
      ...
      {enterPressed && (
        <div>
          ...
          <div
            className="fadeInTopToBottom"
            style={{ "--animation-delay": "2s" }}
          >
            <h2 className="text-2xl font-semibold mb-3 flex items-center">
              <RelatedIcon className="mr-2" />
              Related
            </h2>
      ...
      <div className="fixed bottom-20 inset-x-0 px-4">
        <div className="flex justify-center items-center relative">
          <div
            className={`w-full max-w-2xl ${inputStyle} border-2 border-white flex items-center relative bg-black`}
          >
    ...
    const response = await fetch("https://api.openai.com/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `Generate 3 related questions for the topic "${prompt}".`,
          },
...
async function generateAnswer(prompt, email) {
  console.log("Entering generateAnswer");
  try {
    const response = await fetch("https://ta.ai.ngrok-free.app/query", {
      method: "POST",
      headers: {
        "Content-Type": "application/json", // Ensure the server knows you're sending JSON
      },
      body: JSON.stringify({
        collection_id: email, // Ensure this is the correct collection ID
        query: prompt,
      }),
    });
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Outer circle with a stroke to define the Enter key symbol boundary */}
        <path d="M12 8v8" stroke="#FFA500" strokeWidth="2" />{" "}
        {/* Vertical line representing the Enter key's return stroke */}
        <path d="M8 12l4-4 4 4" stroke="#FFA500" strokeWidth="2" />{" "}
        {/* Arrow, pointing towards the Enter functionality */}
      </svg>
    </div>
  );
}
