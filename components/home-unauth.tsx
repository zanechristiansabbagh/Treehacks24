...
export function HomeUnauth() {
  ...
  return (
    ...
    <div className="absolute top-1/2 left-0 w-full -translate-y-1/2">
      ...
      <div className="text-center z-10 relative"> {/* This container is for your content */}
        <h1 className="text-4xl font-extrabold tracking-tighter sm:text-6xl">
          {title}<span className={`${showCursor ? 'inline' : 'hidden'} cursor`} style={{width: '1px'}}>|</span>
        </h1>
        <div className={`${showContent ? 'fadeIn' : 'opacity-0'}`}>
          <p className="mx-auto max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
            No more knowledge gaps for your students
          </p>
          <div className={`flex justify-center gap-4 mt-8 ${showGetStarted ? 'fadeIn' : 'opacity-0'}`}>
            <Link
